...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7260834916:AAGboVhZCXeIQ5nuzshOMZGUQbkXL7syaWo")
...
#Database --⚠️ REQUIRED--
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://AnimeRavenBots:AnimeRavenBots@animeravenbots.huekk.mongodb.net/?retryWrites=true&w=majority&appName=MahiruShiinaFileBot")
DB_NAME = os.environ.get("DATABASE_NAME", "MahiruShiinaFileBot")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://envs.sh/H7T.jpg")).split() #Required
